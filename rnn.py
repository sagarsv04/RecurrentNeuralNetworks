...
def RNN(x, weights, biases):
    ...
    # uncomment lines below to test but comment out the 2-layer rnn.MultiRNNCell above
    ...
    while step < training_iters:
        ...
        if (step+1) % display_step == 0:
            print("Iter = " + str(step+1) + ", Average Loss="+\
                    "{:.6f}".format(loss_total/display_step) + ", Average Acuuracy = " + \
    ...
    while True:
        ...
        try:
            ...
            for i in range(32):
                ...
                onehot_pred_index = int(tf.arg_max(onehot_pred, 1).eval())
